class ProductPages {
    constructor(page) {
      ...
      this.selectors = {
        ...
        productLink: "(//a[normalize-space()='Product'])[1]",
        ...
        addToCartButton: "(//div[@class='add-cart']//a)[1]",
    ...
    async addToCart() {
      await this.page.waitForSelector(this.selectors.addToCartButton, {timeout:9000});
